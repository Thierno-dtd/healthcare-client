...
export const PAGE_TITLES: Record<string, string> = {
  ...
  'patient/disponibilites': 'Trouver une pharmacie',
  ...
  'patient/suivi-sante': 'Suivi de santé',
  'patient/medicaments': 'Mes Traitements',
  'patient/appel-video': 'Appel Vidéo',
  'medecin/diagnostic-ia': 'Diagnostic IA',
  'medecin/patients': 'Dossiers patients',
  'medecin/cas-speciaux': 'communauté Médicale',
