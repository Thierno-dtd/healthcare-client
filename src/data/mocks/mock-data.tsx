...
export const MOCK_PATIENTS: Patient[] = [
    ...
    { id: 'p_003', name: 'Pierre Martin', email: 'pierre.martin@email.com', phone: '+33 6 33 33 33 33', dateOfBirth: '1952-11-05', gender: 'male', hospitalId: 'h_001', doctorId: 'd_002', status: 'active', conditions: ['insuffisance cardiaque', 'diabète type 2'], lastActivity: '2026-03-15T11:20:00Z', createdAt: '2023-11-10', }, { id: 'p_004', name: 'Sophie Lambert', email: 'sophie.lambert@email.com', phone: '+33 6 44 44 44 44', dateOfBirth: '1990-06-18', gender: 'female', hospitalId: 'h_001', doctorId: 'd_001', status: 'pending', conditions: ['obésité'], lastActivity: '2026-03-10T09:00:00Z', createdAt: '2026-03-10', }, { id: 'p_005', name: 'Alain Rousseau', email: 'alain.rousseau@email.com', phone: '+33 6 55 55 55 55', dateOfBirth: '1945-02-28', gender: 'male', hospitalId: 'h_002', doctorId: 'd_003', status: 'active', conditions: ['hypertension', 'insuffisance rénale'], lastActivity: '2026-03-17T07:15:00Z', createdAt: '2023-08-05', }, { id: 'p_006', name: 'Isabelle Durand', email: 'isabelle.durand@email.com', phone: '+33 6 66 66 66 66', dateOfBirth: '1983-07-14', gender: 'female', hospitalId: 'h_001', doctorId: 'd_002', status: 'suspended', conditions: ['dépression'], lastActivity: '2026-02-01T16:45:00Z', createdAt: '2024-03-01', }, { id: 'p_007', name: 'Nicolas Leroy', email: 'nicolas.leroy@email.com', phone: '+33 6 77 77 77 77', dateOfBirth: '1988-03-20', gender: 'male', hospitalId: 'h_001', doctorId: 'd_001', status: 'active', conditions: ['hypertension'], lastActivity: '2026-03-18T09:00:00Z', createdAt: '2025-01-12', }, { id: 'p_008', name: 'Camille Girard', email: 'camille.girard@email.com', phone: '+33 6 88 88 88 88', dateOfBirth: '2001-11-30', gender: 'female', hospitalId: 'h_002', doctorId: 'd_003', status: 'pending', conditions: ['diabète type 1'], lastActivity: '2026-03-17T12:00:00Z', createdAt: '2026-03-17', },
